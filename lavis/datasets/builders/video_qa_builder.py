...
from lavis.datasets.datasets.mc_video_vqa_datasets_aux import MCVideoQADatasetAux
...
class MCVideoQABuilderAux(BaseDatasetBuilder):
    train_dataset_cls = MCVideoQADatasetAux
    eval_dataset_cls = MCVideoQADatasetAux
...
class CharadesBuilder(MCVideoQABuilder):
    DATASET_CONFIG_DICT = {
        "default": "configs/datasets/charades/defaults_qa.yaml",
    }

@registry.register_builder("charades_test")
class CharadesBuilder(MCVideoQABuilderAux):
    DATASET_CONFIG_DICT = {
        "default": "configs/datasets/charades/defaults_qa_tests.yaml",
    }
